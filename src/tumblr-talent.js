const maker = document.querySelector("#signal-maker");
const talentForm = document.querySelector("#talent-submit");
const talentStatus = document.querySelector("#talent-status");
const formState = document.querySelector("#form-state");
const receipt = document.querySelector("#talent-receipt");
const submitButton = talentForm.querySelector("button[type=submit]");
const canonicalUrl = "https://www.industrynext.xyz/market/tumblr/";
const tags = ["internet people 001", "industry next", "digital skills", "tumblr talent relay"];
